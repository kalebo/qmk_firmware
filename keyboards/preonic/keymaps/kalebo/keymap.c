...
[_GAMING] = LAYOUT_preonic_grid( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, SFT_ENT,  \
  KC_APP,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_APP,  KC_INS,  KC_DEL,  KC_BSPC, \
 ...
 * |      | Reset|      |      |      |      |      |      |      |      |      |  Del |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |      |      |Aud on|AudOff|AGnorm|AGswap|Qwerty|Gaming|Dvorak|      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_preonic_grid( \
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  MAGSYS,  \
  _______, RESET,   DEBUG,   _______, _______, _______, _______, TERM_ON, TERM_OFF,_______, _______, KC_DEL,  \
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  GAMING,  DVORAK,  _______, _______, \
...
_______, _______, KC_ACL0, KC_ACL1, KC_ACL2, _______, _______, KC_BTN1, KC_MS_U, KC_BTN2, _______, _______, \
_______, _______, KC_BTN2, KC_BTN3, KC_BTN1, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, \
_______, _______, _______, KC_WH_D, KC_WH_U, _______, _______, _______, KC_MS_D, KC_WH_D, KC_WH_U, _______, \
_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______  \
)
